...
namespace BTLLTQL.Controllers
{
    public class NCCsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNCC,TenNCC,TenHang,Diachi,SoDienThoai")] NCC nCC)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNCC,TenNCC,TenHang,Diachi,SoDienThoai")] NCC nCC)
        {
            if (ModelState.IsValid)
            {
